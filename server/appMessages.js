module.exports = {
  ...
  'BANK_UPDATE_SUCCESS' : 'This bank has been successfully updated',
  'BANK_DELETE_SUCCESS' : 'This bank has been successfully deleted',
  'TRANS_TYP_ADD_SUCCESS' : 'This transaction type has been successfully saved',
  ...
  'TRANS_TYP_UPDATE_SUCCESS' : 'This transaction type has been successfully updated',
  'TRANS_TYP_DELETE_SUCCESS' : 'This transaction type has been successfully deleted',
  'CURR_INVALID' : 'Invalid Currency Code',
  'ACC_ADD_SUCCESS' : 'This account has been successfully created',
  'ACC_ADD_FAIL': 'Failed to add this account',
  'ACC_NOT_EXIST' : 'This account does not exist in the database',
  'ACC_UPDATE_SUCCESS' : 'This account has been successfully updated',
  'ACC_UPDATE_FAIL': 'Failed to update this account',
  'ACC_DELETE_SUCCESS' : 'This account has been successfully deleted',
  'ACC_DELETE_FAIL': 'Failed to delete this account',
  ...
  'TRANS_DBT_RELEASE_FAIL': 'Failed to release this single transaction from debtor',
  'TRANS_DBT_LINK_SUCCESS': 'This transaction has been successfully linked to debtor',
  'TRANS_DBT_RELEASE_SUCCESS': 'This transaction has been successfully released from debtor',
  ...
  'EXP_UPDATE_SUCCESS': 'This expense has been successfully updated',
  'EXP_TOT_UPDATE_SUCCESS': 'This expense total has been successfully updated',
  ...
  'EXP_DET_UPDATE_SUCCESS': 'This expense detail has been successfully updated',
  'EXP_DET_DELETE_SUCCESS': 'This expense detail has been successfully deleted',
  'EXP_ADD_FAIL': 'Failed to add this expense detail',
  'EXP_DELETE_FAIL': 'Failed to delete this expense detail',
  'EXP_STATUS_CLOSED': 'This expense can not be maintained as it was closed',
  ...
  'CARD_UPDATE_SUCCESS': 'This card has been successfully updated',
  'CARD_DELETE_SUCCESS': 'This card has been successfully deleted',
  ...
  'CARD_INST_DELETE_SUCCESS': 'This card installment has been successfully deleted',
  'CARD_INST_UPDATE_SUCCESS': 'This card installment has been successfully updated',
  'CARD_INST_TERM_SUCCESS': 'This card installment has been successfully terminated',
  'CARD_INST_POST_FAIL': 'Failed to post card installment',
  'CARD_INST_POST_SUCCESS': 'This card installment has been successfully posted',
  ...
  'CARD_TRANS_PAY_SUCCESS': 'This card transaction has been successfully paid',
  'CARD_TRANS_UPDATE_SUCCESS': 'This card transaction has been successfully updated',
  'CARD_TRANS_DELETE_SUCCESS': 'This card transaction has been successfully deleted',
  ...
  'DEBT_UPDATE_SUCCESS': 'This debtor has been successfully updated', 
  'DEBT_DELETE_SUCCESS': 'This debtor has been successfully deleted', 
  ...
  'INST_NOT_EXIST': 'Invalid installment Id',
  'INST_ADD_SUCCESS': 'This installment has been successfully added',
  'INST_UPDATE_SUCCESS': 'This installment has been successfully updated',
  'INST_DELETE_SUCCESS': 'This installment has been successfully deleted',
  'INST_DELETE_FAIL': 'You can not delete this installment as there are installment details',
  'INST_DET_NOT_EXIST': 'Invalid installment detail Id',
  'INST_DET_STATUS_NO_UPDATE': 'Invalid installment detail status to update',
  'INST_DET_ADD_SUCCESS': 'This installment detail has been successfully added',
  'INST_DET_ADD_FAIL': 'Failed to add installment detail',
  'INST_DET_UPDATE_SUCCESS': 'This installment detail has been successfully updated',
  'INST_DET_UPDATE_FAIL': 'Failed to update installment detail',
  'INST_DET_DELETE_SUCCESS': 'This installment detail has been successfully deleted',
  'INST_DET_DELETE_FAIL': 'Failed to delete installment detail',
  'INV_API_KEY': 'Invalid API key',
  'REPORT_ADD_FAIL': 'Failed to add report',
  'REPORT_UPDATE_FAIL': 'Failed to update report',
  'REPORT_DELETE_FAIL': 'Failed to delete report',
  'REPORT_INVALID': 'Invalid Report',
  'REPORT_EXIST': 'Report is already exist',
  'REPORT_UPDATE_SUCCESS': 'This report has been successfully updated',
  'REPORT_ADD_SUCCESS': 'This report has been successfully added',
  'REPORT_DELETE_SUCCESS': 'This report has been successfully deleted',
  'LOGIN_INVALID' : 'Invalid User Name or Password',
  'USER_INACTIVE' : 'User (?) is inactive',
  'PASSWORD_CHANGED' : 'User password has been successfully changed',
  'USER_CHANGED' : 'User name has been successfully changed',
  'LOGOUT_SUCCESS' : 'User logged out successfully',
  'DB_BACKUP_SUCCESS' : 'Database has been backuped successfully',
  'BILL_CREATE_SUCCESS' : 'This bill has been successfully created',
  'BILL_NOT_EXIST' : 'This bill does not exist in the database',
  'BILL_UPDATE_SUCCESS' : 'This bill has been successfully updated',
  'BILL_DELETE_SUCCESS' : 'This bill has been successfully deleted',
  'BILL_CREATE_FAIL' : 'Failed to create this bill',
  'BILL_UPDATE_FAIL' : 'Failed to update this bill',
  'BILLTRANS_CREATE_SUCCESS' : 'This bill transaction has been successfully added',
  'BILLTRANS_CREATE_FAIL' : 'Failed to add this bill transaction',
  'BILLTRANS_NOT_EXIST' : 'This bill transaction does not exist in the database',
