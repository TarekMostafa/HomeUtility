...
class DeleteDebtTransactionModal extends Component {
  state = {
    ...initialState
  }
  ...
  render () {
    return (
      <ModalContainer title="Delete Debt Transaction" show={this.props.show}
  ...
  handleClick = () => {
    ...
    TransactionRequest.deleteDebtTransaction(this.props.transactionId)
    .then( (response) => {
...
export default DeleteDebtTransactionModal;
