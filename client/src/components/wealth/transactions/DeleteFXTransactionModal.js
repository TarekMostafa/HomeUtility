...
class DeleteFXTransactionModal extends Component {
  state = {
    ...initialState
  }
  ...
  render () {
    return (
      <ModalContainer title="Delete FX Transaction" show={this.props.show}
  ...
  handleClick = () => {
    ...
    // delete fx transaction
    TransactionRequest.deleteFXTransaction(this.state.fxId, this.state.idFrom, this.state.idTo)
    .then( (response) => {
...
export default DeleteFXTransactionModal;
