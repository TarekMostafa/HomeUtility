...
class ConvertSingleToDebtModal extends Component {
  state = {
    ...initialState
  }
  ...
  render () {
    return (
      <ModalContainer title="Convert To Debt" show={this.props.show}
  ...
  handleClick = () => {
    ...
    TransactionRequest.convertToDebtTransaction(this.props.transactionId, this.state.debtor)
    .then( (response) => {
      if (typeof this.props.onConvert=== 'function') {
...
export default ConvertSingleToDebtModal;
