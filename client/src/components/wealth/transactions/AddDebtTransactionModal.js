...
class AddDebtTransactionModal extends Component {
  state = {
    ...initialState
  }
  render () {
    return (
      <ModalContainer title="Add Debt Transaction" show={this.props.show}
        ...
        <Form>
          ...
          <Form.Group controlId="crdr">
            <Row>
              ...
              <Col>
                <Form.Check inline type="radio" label="Credit" name="crdr" value="Credit" onChange={this.handleChange}/>
              </Col>
              <Col>
  ...
  handleClick = () => {
    ...
    TransactionRequest.addDebtTransaction(this.state.account, this.state.postingDate,
