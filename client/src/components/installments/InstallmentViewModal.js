...
function InstallmentViewModal(props) {
    ...
    return (
        <ModalContainer title={props.instId?"View Installment ("+props.instId+")":"View Installment"}  
...
export default InstallmentViewModal;