...
function InstallmentDetailDeleteModal(props) {
    ...
    const handleClick = () => {
        ...
        InstallmentDetailRequest.deleteInstallmentDetail(props.instDetId)
        .then( () => {
    ...
    return (
        <ModalContainer title={props.instDetId?"Delete Installment Detail ("+props.instDetId+")":"Delete Installment Detail"}  
...
export default InstallmentDetailDeleteModal;