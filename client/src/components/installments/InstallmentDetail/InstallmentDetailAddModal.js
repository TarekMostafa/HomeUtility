...
function InstallmentDetailAddModal(props) {
    ...
    const handleClick = () => {
        ...
        InstallmentDetailRequest.addInstallmentDetail(props.instId, formData.instDetDate, 
    ...
    return (
        <ModalContainer title="Add New Installment Detail" show={props.show}
            ...
            <form>
                ...
                <Form.Group controlId="instDetAmount">
                    ...
                    <InputGroup>
                        ...
                        name="instDetAmount"
                        value={Number(formData.instDetAmount).toFixed(props.decimalPlaces)}
                ...
                <Form.Group controlId="instDetStatus">
                    ...
                    <Form.Control as="select" name="instDetStatus" onChange={handleChange}>
                        <option value=''></option>
...
export default InstallmentDetailAddModal;